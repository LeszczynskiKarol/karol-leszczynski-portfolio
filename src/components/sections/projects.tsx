...
export function ProjectsSection() {
  ...
  // DODAJ TEN BLOK - obsługa historii przeglądarki
  useEffect(() => {
    if (selectedProject) {
      // Dodaj stan do historii gdy modal się otwiera
      window.history.pushState({ modal: true }, "");

      // Obsłuż przycisk cofania
  ...
  const closeModal = () => {
    setSelectedProject(null);
    // Tylko cofnij jeśli modal był w historii
